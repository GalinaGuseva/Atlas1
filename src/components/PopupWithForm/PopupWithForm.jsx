        ...
        <form className='popup-form' onSubmit={handleSubmit} noValidate>
          ...
          <label className='popup__field_thin'>
            <input
              ...
              checked={accept}
            />
            <span className='popup__thin'>
              Соглашаюсь с{' '}
              <Link to='/policy' className='popup__btn'>
          ...
          <span className='popup__agree-error error'>{errorText}</span>
          <span className='popup__success success'>{success}</span>
          <span className='popup__error error'>{error}</span>
          <span className='popup__sending sending'>{isSending}</span>
        </form>
      </div>
    </div>
  ) : null;
