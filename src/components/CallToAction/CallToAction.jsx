  ...
  return (
    <section className='call'>
      <div className='call__center'>
        <form className='call__form' onSubmit={handleSubmit} noValidate>
          ...
          <label className='call__field_thin'>
            <input
              ...
              checked={accept}
            />
            <span className='call__thin link'>
              Соглашаюсь с{' '}
              <Link to='/policy' className='call__btn'>
          ...
          <div className='call__recaptcha'>
            <ReCAPTCHA
              sitekey={key}
              onChange={() => setIsCaptchaSuccess(true)}
            />
          </div>
          <span className='call__agree-error error'>{errorText}</span>
          <span className='call__success success'>{success}</span>
          <span className='call__error error'>{error}</span>
          <span className='call__sending sending'>{isSending}</span>
        </form>

        <div className='call__text'>
          <div className='call__title'>
            Автоматизируйте аптеку с&nbsp;системой “Атлас”
          </div>
          <div className='call__subtitle'>
            Попробуйте бесплатно, чтобы ощутить реальные выгоды в своей работе
          </div>
          <ul className='call__icons'>
            <li className='call__item'>
              <img src={maps} alt='maps' className='call__icon' />
              <p className='call__icontext'>
            ...
            <li className='call__item'>
              ...
              <p className='call__icontext'>
                Гибкая система ценообразования и скидок
              </p>
            </li>
            <li className='call__item'>
              <img src={gift} alt='gift' className='call__icon' />
              <p className='call__icontext'>
                Повышение доходности с помощью автоматизации
              </p>
            </li>
          </ul>
        </div>
